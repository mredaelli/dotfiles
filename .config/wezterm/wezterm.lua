...
local keys = {
	...
	key("y", { SwitchToWorkspace = workspace("platform/analytics") }, "CTRL|SUPER"),
	key("h", { SwitchToWorkspace = workspace("platform/hub") }, "CTRL|SUPER"),
	...
	key("u", { SwitchToWorkspace = workspace("platform/lari_utils") }, "CTRL|SUPER"),
